...
// Minimal inline icon set (24x24, stroke-based) so the app has zero icon deps.
const PATHS: Record<string, string> = {
  ...
  chat: "M21 11.5a8.4 8.4 0 0 1-9 8.4 8.6 8.6 0 0 1-3.8-.9L3 21l2-4.2A8.4 8.4 0 0 1 3 11.5a8.4 8.4 0 0 1 9-8.4 8.4 8.4 0 0 1 9 8.4z",
  ...
  route: "M6 19a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM18 11a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM6 13V9a2 2 0 0 1 2-2h5M18 11v4a2 2 0 0 1-2 2h-5",
  sun: "M12 17a5 5 0 1 0 0-10 5 5 0 0 0 0 10zM12 1v2M12 21v2M4.2 4.2l1.4 1.4M18.4 18.4l1.4 1.4M1 12h2M21 12h2M4.2 19.8l1.4-1.4M18.4 5.6l1.4-1.4",
  umbrella: "M23 12a11.05 11.05 0 0 0-22 0zM12 12v7a2 2 0 0 0 4 0",
  droplet: "M12 2.7s-6.5 7-6.5 11.3a6.5 6.5 0 0 0 13 0C18.5 9.7 12 2.7 12 2.7z",
...
/** CrewGuard logomark: shield with a sun-wave, rendered as a solid ink blob. */
export function Logo({ size = 34, className = "" }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 40 40" className={className} aria-label="CrewGuard">
      <path d="M20 3 6 8v11c0 8.5 6 14.5 14 18 8-3.5 14-9.5 14-18V8z" fill="currentColor" />
      <path d="M12 23.5c2.2-2.6 4.2-2.6 6.4 0s4.2 2.6 6.4 0" stroke="#fff" strokeWidth="2.6" strokeLinecap="round" fill="none" />
      <circle cx="20" cy="15.5" r="3.4" fill="#F2B233" />
    </svg>
  );
}
